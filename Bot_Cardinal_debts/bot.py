...
creds = ServiceAccountCredentials.from_json_keyfile_name('Bot_Cardinal_debts/credentials.json', scope)
client = gspread.authorize(creds)

# Открытие таблицы
SPREADSHEET_ID = '14gAgD05ch-av0D70SAGOzaPdW2pkrcVaSIJT0rbv-No'
...
def main():
    TELEGRAM_TOKEN = '7926404330:AAGTf4-rOKT9XC78I5PIENoNUXHfdsHwbIA'
